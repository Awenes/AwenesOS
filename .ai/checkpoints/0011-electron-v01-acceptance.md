...
8. Review completion evidence, finish the task locally, and verify its timing, notification, and final state.

## Preserved exclusions

CRM/SharePoint/task-management integration, remote development environments, unattended execution while the PC sleeps, and Tauri are not included. Windows command and network restrictions are Awenes tool-boundary controls and are not represented as an OS sandbox.
